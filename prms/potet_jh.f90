...
!***********************************************************************
      ...
      USE PRMS_CONSTANTS, ONLY: RUN, DECL, INIT, Nmonths, INCH2CM, ACTIVE
...
! Local Variables
      ...
      REAL, ALLOCATABLE :: Jh_coef_sngl(:, :), Jh_coef_hru_sngl(:)
!***********************************************************************
      potet_jh = 0
...
!******Get parameters
      ELSEIF ( Process_flag==INIT ) THEN
        ALLOCATE ( Jh_coef(Nhru,Nmonths), Jh_coef_hru_sngl(Nhru) )

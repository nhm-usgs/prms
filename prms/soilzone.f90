...
!***********************************************************************
      ...
      USE PRMS_MODULE, ONLY: Model, Nhru, Nlake, Print_debug, Cascade_flag, Nmonths
      USE PRMS_SOILZONE
      IMPLICIT NONE
! Functions
...
!***********************************************************************
      ...
      USE PRMS_MODULE, ONLY: Nhru, Nssr, Nlake, Dprst_flag, Init_vars_from_file, Cascade_flag, Nmonths
      USE PRMS_SOILZONE

...
!***Declare Procedure***
      ELSEIF ( Process(:4)=='decl' ) THEN
        Version_write_climate_hru = '$Id: write_climate_hru.f90 5528 2013-03-22 21:54:44Z rsregan $'
        CALL print_module(Version_write_climate_hru, 'Climate Distribution      ', 90)

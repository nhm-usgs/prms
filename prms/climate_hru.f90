...
!        CHARACTER(LEN=MAXFILE_LENGTH) :: Pk_depth_day, Snow_evap_day, Snowcov_area_day
     ...
     &    Transp_on, Basin_transp_on, Tmax_allsnow_f, Basin_humidity, Ppt_zero_thresh
      ...
      USE PRMS_FLOWVARS, ONLY: Pkwater_equiv, Basin_pweqv
!      USE PRMS_SNOW, ONLY: Basin_snowevap, Basin_snowmelt, Basin_snowcov, Basin_snowdepth, &
!     &    Pk_depth, Snow_evap, Snowcov_area, Snowmelt

...
!***********************************************************************
     ...
     &    Dyn_ag_soil_flag, AG_flag, Dyn_ag_frac_flag
...
!***********************************************************************
     ...
     &    Dprst_vol_thres_open, Dprst_vol_open_frac, Dprst_vol_clos_frac, Dprst_vol_frac
      USE PRMS_IT0_VARS, ONLY: It0_soil_moist, It0_basin_soil_moist, It0_dprst_stor_hru, &
     &                         It0_basin_ssstor, It0_ssres_stor, It0_ag_soil_moist, It0_ag_soil_rechr
...
!            print *, 'to_slow_stor', to_slow_stor
      ...
      IF ( check_sm_max_flag==ACTIVE .OR. check_fractions==ACTIVE ) THEN
        DO j = 1, Active_hrus
          ...
          IF ( AG_flag==ACTIVE ) Soil_moist_tot(i) = Soil_moist_tot(i) + Ag_soil_moist(i)*Ag_frac(i)
        ENDDO
      ENDIF

...
!***********************************************************************
     ...
     &    Hru_type, Basin_area_inv, Dprst_area_max, Hru_frac_imperv, Hru_frac_dprst, Cov_type, Hru_storage, &
     &    Covden_win, Covden_sum, Hru_area, Snowpack_threshold
     ...
     &    Basin_lakeevap, Sroff, Hru_actet, Pkwater_equiv, Gwres_stor, Dprst_vol_open, Dprst_vol_clos, Basin_sroff
      USE PRMS_IT0_VARS, ONLY: It0_soil_moist, It0_ssres_stor, It0_basin_soil_moist, &
                               It0_basin_ssstor, It0_pkwater_equiv
...
! srunoff balance
     ...
     &              Imperv_stor_ante(i), Infil(i), Hortonian_flow(i), Hru_impervstor(i), &
...
!        Hru_runoff(i) = hru_out - DBLE( Hru_actet(i) )
       ...
       &                      Pptmix(i)
          ...
          IF ( Dprst_flag==ACTIVE ) THEN
            ...
            WRITE ( BALUNT, * ) 'dprst', Dprst_evap_hru(i), Dprst_stor_ante(i), Dprst_stor_hru(i), Dprst_seep_hru(i), Dprst_insroff_hru(i)
          ENDIF
...
! intcp note, changeover added to net_rain
     ...
     &                         Last_intcp_stor, Basin_changeover, Basin_net_apply, Basin_hru_apply
        WRITE ( BALUNT, '(A,/)' ) '################################'
      ENDIF

...
! Functions
      ...
      EXTERNAL :: prms_summary, nhru_ncf, nsegment_ncf, module_doc, convert_params, read_error
! Local Variables
...
!      IF ( NsegmentOutON_OFF>OFF ) CALL nsegment_summary()
      IF ( NsegmentOutON_OFF>OFF ) CALL nsegment_ncf()
...
! Functions
      ...
      EXTERNAL ::  nhru_ncf, nsegment_ncf, prms_summary, water_balance, nsub_summary, basin_summary

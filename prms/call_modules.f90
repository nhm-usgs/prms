...
! Control parameters
      ...
      INTEGER, SAVE :: Frozen_flag, Glacier_flag, Snow_cbh_flag, Gwflow_cbh_flag
...
!***********************************************************************
      ...
      IF ( Model_mode(:4)=='PRMS' .OR. Model_mode(:4)=='prms' .OR. Model_mode(:4)=='    ' .OR. Model_mode(:5)=='DAILY' ) THEN
        Model = 1

...
!***********************************************************************
      MODULE PRMS_DYNAMIC_PARAM_READ
        ...
        character(len=*), parameter :: Version_dynamic_param_read = '2022-09-07'
...
!***********************************************************************
     ...
     &    Dyn_snareathresh_flag, Et_flag, PRMS4_flag
      USE PRMS_DYNAMIC_PARAM_READ
...
! Local Variables
      INTEGER :: i, istop, check_dprst_depth_flag, check_sm_max_flag, check_srechr_max_flag, ios

...
..\..\..\bin\prms .\prms.control -set start_time 1983,12,02,0,0 -set csv_output_file ..\output\prms_summary15.out -set model_output_file ..\output15.out -set basinOutBaseFileName ..\output\basinOut_15 -set var_init_file ..\output\prms_ic_14 -set var_save_file ..\output\prms_ic_15

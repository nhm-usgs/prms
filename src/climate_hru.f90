...
!***********************************************************************
      MODULE PRMS_CLIMATE_HRU
        ...
        ! Local Variables
        INTEGER, SAVE :: Precip_unit, Tmax_unit, Tmin_unit
      ...
      USE PRMS_MODULE, ONLY: Process, Nhru, Model, &
     &    Climate_precip_flag, Climate_temp_flag, &
     &    Start_year, Start_month, Start_day, Cbh_check_flag, Cbh_binary_flag

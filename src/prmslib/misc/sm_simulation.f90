submodule (Simulation_class) sm_simulation
  ...
  contains
    ...
    module function constructor_Simulation(ctl_data) result(this)
      ...
      this%model_temp = Temperature_hru(ctl_data, this%model_basin, this%summary_by_basin, this%summary_by_hru)

      allocate(Precipitation_hru::this%model_precip)
      this%model_precip = Precipitation_hru(ctl_data, this%model_basin, this%model_temp, this%summary_by_basin, this%summary_by_hru)

      this%climate = Climateflow(ctl_data, this%model_basin, this%summary_by_hru)

      this%solrad = Solrad_degday(ctl_data, this%model_basin, this%summary_by_basin, this%summary_by_hru)
      this%transpiration = Transp_tindex(ctl_data, this%model_basin, this%model_temp)
      this%potet = Potet_jh(ctl_data, this%model_basin, this%summary_by_basin, this%summary_by_hru)
      this%intcp = Interception(ctl_data, this%model_basin, this%transpiration, this%summary_by_basin, this%summary_by_hru)
      this%snow = Snowcomp(ctl_data, this%model_basin, this%climate, this%summary_by_basin, this%summary_by_hru)
      this%runoff = Srunoff(ctl_data, this%model_basin, this%summary_by_basin, this%summary_by_hru)
      this%soil = Soilzone(ctl_data, this%model_basin, this%climate, this%snow, this%summary_by_basin, this%summary_by_hru)
      this%groundwater = Gwflow(ctl_data, this%model_basin, this%climate, this%intcp, this%soil, this%runoff, this%summary_by_basin, this%summary_by_hru)
      this%model_muskingum = Muskingum(ctl_data, this%model_basin, this%model_time, this%summary_by_basin, this%summary_by_hru)
    ...
    module subroutine run_Simulation(this, ctl_data)
      ...
      do
        ...
        call this%model_temp%run(ctl_data, this%model_basin, this%model_time, this%summary_by_hru)
        ! print *, '1'
        call this%model_precip%run(ctl_data, this%model_basin, this%model_temp, this%model_time, this%summary_by_hru)

module rScalar_class
  ...
  type, extends(Abc) :: rScalar
    ...
    contains
      procedure, public, pass(this) :: print => print_rScalar
        !! Print the class to the screen
      procedure, public, pass(this) :: read => read_rScalar
  ...
  interface rScalar
    ...
    module procedure :: constructor_rScalar
  end interface

  contains
    !====================================================================!
    function constructor_rScalar(value) result(this)
      type(rScalar) :: this
        !! rScalar class
    ...
    !====================================================================!
    subroutine print_rScalar(this, delim)
      class(rScalar), intent(in) :: this
        !! rScalar class
    ...
    !====================================================================!
    subroutine read_rScalar(this, iUnit)
      class(rScalar), intent(inout) :: this
        !! rScalar Class

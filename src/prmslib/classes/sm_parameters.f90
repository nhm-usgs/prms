        ...
        if (buf(:4) == ENTRY_DELIMITER) then
          ...
          select case(buf)
            ...
            case('obsout_segment')
              ...
              call this%obsout_segment%print()
            case('op_flow_thres')
            ...
            case('parent_poigages')
              ...
              call this%parent_poigages%print()
            case('parent_segment')
              ...
              call this%parent_segment%print()
            case('parent_ssr')
            ...
            case('prcp_wght_dist')
              ...
              call this%prcp_wght_dist%print()
            case('precip_units')
            ...
            case('psta_freq_nuse')
              ...
              call this%psta_freq_nuse%print()
            case('psta_mon')
            ...
            case('psta_month_ppt')
              ...
              call this%psta_month_ppt%print()
            case('psta_nuse')
            ...
            case('soil_moist_init_frac')
              ...
              call this%soil_moist_init_frac%print()
            case('soil_moist_max')
              ...
              call this%soil_moist_max%print()
            ...
            case('temp_wght_dist')
              ...
              call this%temp_wght_dist%print()
            case('tmax_add')
            ...
            case('tmax_allrain_dist')
              ...
              call this%tmax_allrain_dist%print()
            ...
            case('tmax_allrain_sta')
              ...
              call this%tmax_allrain_sta%print()
            case('tmax_allsnow')
            ...
            case('tmax_allsnow_dist')
              ...
              call this%tmax_allsnow_dist%print()
            case('tmax_allsnow_sta')
              ...
              call this%tmax_allsnow_sta%print()
            case('tmax_cbh_adj')
            ...
            case('tsta_month_max')
              ...
              call this%tsta_month_max%print()
            case('tsta_month_min')
              ...
              call this%tsta_month_min%print()
            case('tsta_nuse')
